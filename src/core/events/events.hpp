...
namespace trimana::core {
	...
	enum class event_type {
		...
		keyboard_key_press = TRIMANA_BIT(8),
		keyboard_key_release = TRIMANA_BIT(9),
		keyboard_key_repeat = TRIMANA_BIT(10),
		keyboard_key_char = TRIMANA_BIT(11),
		mouse_button_press = TRIMANA_BIT(12),
		mouse_button_release = TRIMANA_BIT(13),
		mouse_wheel = TRIMANA_BIT(14),
		mouse_cursor_moved = TRIMANA_BIT(15),
		mouse_cursor_enter = TRIMANA_BIT(16),
		mouse_cursor_leave = TRIMANA_BIT(17)
	};
